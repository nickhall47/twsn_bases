...
Hci.prototype.createLeConn = function(address, addressType) {
  ...
  cmd.writeUInt16LE(0x004c, 17); // min interval // Default: 0x0006    95ms = 0x004c   950ms = 0x02f8
  cmd.writeUInt16LE(0x0050, 19); // max interval // Default: 0x000c   100ms = 0x0050  1000ms = 0x320
